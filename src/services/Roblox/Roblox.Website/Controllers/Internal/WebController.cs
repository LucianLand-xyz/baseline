...
public class WebController : ControllerBase
{
    ...
    public async Task<dynamic> GetJoinScript(long placeId)
    {
        ...
        var bootstrapperArgs = $"://1+launchmode:play+gameinfo:{Request.Cookies[".ROBLOSECURITY"]}+placelauncherurl:{Configuration.BaseUrl}/game/PlaceLauncher.ashx?placeId={placeId}+k:l+authenticationurl:http://www.moonic.wtf/Login/Negotiate.ashx";
        var args =
