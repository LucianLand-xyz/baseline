...
namespace Roblox.Website.Controllers
{
    ...
    public class BypassController : ControllerBase
    {
        ...
        [HttpGetBypass("/mobileapi/check-app-version"), HttpPostBypass("/mobileapi/check-app-version")]
        public Task<dynamic> CheckAppVersion()
        {
        ...
        [HttpGetBypass("/mobileapi/securesignup"), HttpPostBypass("/mobileapi/securesignup")]
        public dynamic SecureSignup()
        {
            return true;
        }

        [HttpGetBypass("/device/initialize"), HttpPostBypass("/device/initialize")]
        public dynamic initdevice()
        {
        // set headers
        HttpContext.Response.Headers.Add("server", "envoy");
        HttpContext.Response.Headers.Add("x-envoy-upstream-service-time", "3");
        HttpContext.Response.Headers.Add("x-roblox-region", "us-central");
        HttpContext.Response.Headers.Add("x-roblox-edge", "sjc1");
        HttpContext.Response.Headers.Add("report-to", "{\"group\":\"network-errors\",\"max_age\":604800,\"endpoints\":[{\"url\":\"https://ncs.roblox.com/upload\"}]}");
        HttpContext.Response.Headers.Add("nel", "{\"report_to\":\"network-errors\",\"max_age\":604800,\"success_fraction\":0.001,\"failure_fraction\":1}");
        return new { browserTrackerId = 1234567890, appDeviceIdentifier = (string?)null };
        }

        // MOBILEAPI LOGIN
        // username= password= POST
        // [HttpPostBypass("/mobileapi/login"), HttpPostBypass("/mobileapi/userinfo")]
        // public async Task<dynamic> MobileLogin(string username, string password)
        // {
        //     string status = "OK";
        //     object[] userInfo = Array.Empty<object>();

        //     // if cookie .ROBLOSECURITY is set, remove it
        //     if (Request.Cookies.ContainsKey(".ROBLOSECURITY"))
        //     {
        //         HttpContext.Response.Cookies.Delete(".ROBLOSECURITY");
        //     }
        ...
        //                 TicketsBalance = 0,
        //                 IsAnyBuildersClubMember = false,
        //                 ThumbnailUrl = "https://www.moonic.wtf/Thumbs/Avatar.ashx?x=100&y=100&Format=Png&userId=" + user.userId
        //             }
        //         };
        //         var session = await services.users.CreateSession(userId);
        ...
        //         throw new RobloxException(400, 0, "BadRequest");
        //     } catch (Exception e) {
        //         Console.WriteLine("[MOBILEAPI] Error caught! This is in Login.");
        //         Console.WriteLine(e);
        //         throw new RobloxException(500, 0, "InternalServerError");
        //     }
        // }
	...
	"UserInfo": {	
		"UserName": "obvious",			
		"RobuxBalance": Roambuscks,				
		"TicketsBalance": tix :p,				
		"IsAnyBuildersClubMember": false or true,				
		"ThumbnailUrl": "url to any image type. can be blank",				
		"UserID": (UserID)		
	}		
}
*/
        return new {
            ...
            UserInfo = new {
                ...
                TicketsBalance = 0,
                IsAnyBuildersClubMember = false,
                ThumbnailUrl = "https://www.moonic.wtf/Thumbs/Avatar.ashx?x=100&y=100&Format=Png&userId=1",
                UserID = 696969
            }
        };
        }
        ...
        [HttpGetBypass("/IDE/welcome")]
        public dynamic IDEWelcome()
        {
            return "Welcome to Moonic Studio! Login & Signup are not functional, this is only for viewing and editing game files.";
        }
        ...
        public async Task ReportPlayerActivity([Required, MVC.FromBody] ReportPlayerActivity request)
        {
            if (!IsRcc())
            {
                Console.WriteLine("[info] Got bad request on /gs/players/report");
                throw new BadRequestException();
            }
            Console.WriteLine("[info] reporting stat for player " + request.userId);
        ...
        [HttpGetBypass("/game/validate-machine")]
        ...
        [HttpGetBypass("/game/load-place-info.ashx")]
        // {"CreatorId":4,"CreatorType":"User", "PlaceVersion":1, "GameId":4,"IsRobloxPlace":true}
        public async Task<dynamic> LoadPlaceInfo(long placeId)
        {
        return new
            {
                CreatorId = 1,
        ...
        public MVC.ActionResult<dynamic> AllowedMD5Hashes()
        {
            ...
            {
                "abf3d48aca0e0ac48114d1b36275dced"
            };
        ...
        // just returns "true" no quotes with content type as text/plain
        [HttpGetBypass("universes/validate-place-join")]
        public bool ValidatePlaceJoin()
        {
