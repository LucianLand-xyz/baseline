...
public class Invite : RobloxPageModel
{
    ...
    private async Task OnPageLoad()
    {
        ...
        // if userSession.userid = 1 or 2, cancreatinvite is true
        ...
        if (userInfo.created > DateTime.UtcNow.Subtract(TimeSpan.FromDays(1)) && userSession.userId != 1 && userSession.userId != 2)
        {
